...
# load files===========================================================================================================
trending_products = pd.read_csv(r"C:\Users\Ashish\Desktop\Ecommerece Product Recommendation System\models\trending_products.csv")
train_data = pd.read_csv(r"C:\Users\Ashish\Desktop\Ecommerece Product Recommendation System\models\clean_data.csv")
item_name = "Laptop"
...
@app.route('/main')
def main():
    # Assuming you have a function that generates content-based recommendations
    content_based_rec = content_based_recommendations(train_data,item_name)
