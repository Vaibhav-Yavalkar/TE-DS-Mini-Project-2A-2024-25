...
def lunges_frames():
    """Detect and count lunges using webcam feed."""
    ...
    with mp_pose.Pose(min_detection_confidence=0.5, min_tracking_confidence=0.5) as pose:
        while True:
            ...
            try:
                # Extract landmarks for lunges (left leg)
                ...
                # Update stage and counter based on knee angle
                if knee_angle > 160:
                    stage = "up"
            ...
            cv2.putText(image, 'LUNGES', (50,50), 
